const Newsletter = ({product} : {product: any}) => {
  const enquiryText = `I want to enquire about the product: ${product.name}. Please provide more details.`;
  return (
    <div
    ...
    >
      ...
      <a href={`https://api.whatsapp.com/send?phone=+919885871121&text=${encodeURIComponent(enquiryText)}`} target="_blank" rel="noopener noreferrer">
        <button
          type="button"
