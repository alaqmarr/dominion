...
const Footer = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-[#F2C078] pt-20 lg:pt-[100px]"
      data-wow-delay=".15s"
    >
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <Link href="/" className="mb-6 inline-block max-w-[160px] text-red font-extrabold">
                <p
                className="mb-2 text-xl font-bold text-red"
                >
            ...
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <Link
                    href="/"
                    className="mb-3 inline-block text-base text-black hover:text-primary"
                  >
                    Home
                  </Link>
                </li>
            ...
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start">
                  <Link
                    href="#"
                    className="px-3 text-base text-black hover:text-white hover:underline"
                  >
                    Privacy policy
                  </Link>
                  <Link
